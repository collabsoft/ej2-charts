    ...
    describe('Annotation for Chart', () => {
        ...
        it('Checking annotaiton in series region', (done: Function) => {
            ...
            chartObj.loaded = (args: Object): void => {
                ...
                expect(element.children[0].childElementCount).toBe(2);
                element = getElement('container_Annotation_0');
                expect((element as HTMLElement).style.left == '335.75px' || (element as HTMLElement).style.left == '341.75px').toBe(true);
                expect((element as HTMLElement).style.top == '218px' || (element as HTMLElement).style.top == '216.5px').toBe(true);
                element = getElement('container_Annotation_1');
                expect((element as HTMLElement).style.left == '311.641px' || (element as HTMLElement).style.left == '317.641px').toBe(true);
        ...
        it('Checking annotaiton in point units', (done: Function) => {
            ...
            chartObj.loaded = (args: Object): void => {
                element = getElement('container_Annotation_0');
                expect((element as HTMLElement).style.left == '343.031px' || (element as HTMLElement).style.left == '349.085px').toBe(true);
                expect((element as HTMLElement).style.top == '134.226px' || (element as HTMLElement).style.top == '136.324px').toBe(true);
                element = getElement('container_Annotation_1');
                expect((element as HTMLElement).style.left == '324.975px' || (element as HTMLElement).style.left == '318.922px').toBe(true);
