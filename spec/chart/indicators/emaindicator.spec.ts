...
Chart.Inject(Zoom, Legend, EmaIndicator, LineSeries, CandleSeries, Category, Tooltip, Crosshair);
    ...
    describe('EMA Technical Indicators', () => {
        ...
        it('EMA Technical indicator using panels', (done: Function) => {
            loaded = (args: Object): void => {
                ...
                expect((Math.round(rect.top) === 370)
                    || rect.top == 368.9305114746094).toBe(true);
                done();
            };
