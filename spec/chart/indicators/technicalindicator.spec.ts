...
Chart.Inject(Zoom, Legend, SmaIndicator, LineSeries, CandleSeries, Category, Tooltip, Crosshair);
    ...
    describe('SMA Technical Indicators', () => {
        ...
        it('SMA Technical indicator for a series with negative points', (done: Function) => {
            loaded = (args: Object): void => {
                ...
                expect(chartObj.visibleSeries[1].points[3].y).toBe(-0.39999999999999974);
                done();
        ...
        it('SMA Technical indicator using panels', (done: Function) => {
            loaded = (args: Object): void => {
                ...
                expect(Math.round(rect.top) === 368 || Math.round(rect.top) === 369).toBe(true);
                done();
            };
