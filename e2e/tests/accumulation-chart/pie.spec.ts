...
describe('category and log axis', () => {
    it('checking pie chart', () => {
         ...
         browser.compareScreen(element(By.id('chart')), 'pie_chart');
    });
    it('checking with explode', () => {
        ...
        browser.compareScreen(element(By.id('chart')), 'pie_chart_explode');
        pieExplodePoint.click();
        pyramidExplodePoint.click();
        browser.compareScreen(element(By.id('chart')), 'pie_chart_explode_removed');
    });
