...
describe('Box and Whisker', () => {
    it('all modes', () => {
        ...
        browser.compareScreen(element(By.id('container')), 'boxandwhisker_all_Modes');
    });
    it('inversed', () => {
        let inversed: ElementFinder;
        inversed = element(by.id('axisinversed'));
        inversed.click();
        browser.compareScreen(element(By.id('container')), 'boxandwhisker_inversed');
        inversed.click();
    });
    it('vertical', () => {
        ...
        vertical.click();
        browser.compareScreen(element(By.id('container')), 'boxandwhisker_vertical');
        vertical.click();
    });
});