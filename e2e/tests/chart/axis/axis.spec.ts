...
describe('DateTime-Numeric axis', () => {
    ...
    it('default', () => {
         ...
         browser.compareScreen(element(By.id('container')), 'default_date_double');
    });
    it('xAxis inversed', () => {
        ...
        yInversed.click();
        browser.compareScreen(element(By.id('container')), 'dateTime_double_Inversed');
        xInversed.click();
        yInversed.click();
    });
    it('checked with minimum for axis', () => {
        ...
        minimum.click();
        browser.compareScreen(element(By.id('container')), 'datetime_doule_minimum');
        minimum.click();
    });
    it('checked with maximum for axis', () => {
        let maximum: ElementFinder = element(by.id('maximum'));
        maximum.click();
        browser.compareScreen(element(By.id('container')), 'datetime_doule_maximum');
        maximum.click();
    });
    it('checked with interval axis', () => {
        let interval: ElementFinder = element(by.id('interval'));
        interval.click();
        browser.compareScreen(element(By.id('container')), 'datetime_doule_interval');
        interval.click();
    });
    it('checked with range axis', () => {
        let range: ElementFinder = element(by.id('range'));
        range.click();
        browser.compareScreen(element(By.id('container')), 'datetime_doule_range');
        range.click();
    });
    it('checked double RangePadding none', () => {
        rangePadding = element(by.id('rangePadding'));
        rangePadding.click();
        browser.compareScreen(element(By.id('container')), 'rangePad_double');
        rangePadding.click();
    });
    it('checked dateTime RangePadding additional', () => {
        ...
        browser.compareScreen(element(By.id('container')), 'rangePad_dateTime_Additional');
    });
    it('checked dateTime RangePadding round', () => {
        ...
        browser.compareScreen(element(By.id('container')), 'rangePad_dateTime_round');
    });
    it('checked format double', () => {
        let labelFormatD: ElementFinder = element(by.id('labelFormatD'));
        labelFormatD.click();
        browser.compareScreen(element(By.id('container')), 'labelFormat_double');
        labelFormatD.click();
    });
...
describe('smart axis', () => {
    ...
    it('default', () => {
         ...
         browser.compareScreen(element(By.id('container')), 'default_smartAxis');
    });
    it('checked label intersect', () => {
        labelIntersect = element(by.id('labelIntersect'));
        labelIntersect.click();
        browser.compareScreen(element(By.id('container')), 'labelIntersect_smartAxis');
    });
    it('checked label intersect with x inversed', () => {
        xInversed.click();
        browser.compareScreen(element(By.id('container')), 'labelIntersect_xInversed');
        xInversed.click();
        labelIntersect.click();
    });
    it('checked edge label', () => {
        ...
        edgeLabel.click();
        browser.compareScreen(element(By.id('container')), 'edgeLabel');
    });
    it('checked edge label yInversed', () => {
        yInversed.click();
        browser.compareScreen(element(By.id('container')), 'edgeLabel_yInversed');
        yInversed.click();
    });
});
describe('checking dateTime and edgeLabel', () => {
    ...
    it('checking normal Axis', () => {
        ...
        browser.compareScreen(element(By.id('container')), 'edgeLabel_dateTimeAxis');
    });
});
...
describe('checking gridlines', () => {
    ...
    it('checking normal Axis', () => {
        ...
        browser.compareScreen(element(By.id('container')), 'gridLines');
    });
    it('checking inversed Axis', () => {
        xInversed.click();
        yInversed.click();
        browser.compareScreen(element(By.id('container')), 'gridLines_inversed');
        xInversed.click();
        yInversed.click();
    });
});