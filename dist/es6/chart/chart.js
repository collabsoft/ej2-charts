...
import { SvgRenderer, Browser, Touch } from '@syncfusion/ej2-base';
...
import { textElement, withInBounds, RectOption, ChartLocation, stringToNumber } from './utils/helper';
...
import { LegendSettings } from './legend/legend';
import { Indexes } from './user-interaction/selection';
import { chartMouseClick, chartMouseLeave, chartMouseDown, chartMouseMove, chartMouseUp, load } from './model/constants';
var Chart = (function (_super) {
    ...
    Chart.prototype.processData = function () {
        ...
        for (var _i = 0, _a = this.visibleSeries; _i < _a.length; _i++) {
            ...
            series_1.xData = [];
            series_1.yData = [];
            series_1.dataModule = new Data(this, series_1);
            series_1.points = [];
    ...
    Chart.prototype.unWireEvents = function () {
        ...
        if (Browser.isTouch && this.isOrientation()) {
            EventHandler.remove(window, 'orientationchange', this.chartResize);
        }
        else {
            EventHandler.remove(window, 'resize', this.chartResize);
        }
    };
    ...
    Chart.prototype.wireEvents = function () {
        ...
        if (Browser.isTouch && this.isOrientation()) {
            EventHandler.add(window, 'orientationchange', this.chartResize, this);
        }
        else {
            EventHandler.add(window, 'resize', this.chartResize, this);
        }
